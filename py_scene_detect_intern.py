...
if __name__ == "__main__":
    ...
    main_out_dir = "/mnt/sdb/dataset/InterQA/video_frames"
    with open("/home/hetianyao/Video-LLaVA-PG/datasets/InternVid-QA/video_list.json", "r") as f:
        video_list = json.load(f)
    finished_list = os.listdir("/mnt/sdb/dataset/InterQA/video_frames")
    ...
    for video_path in tqdm(video_list[1:]):
        try:
            ...
            detect_scenes_with_adaptive_threshold(video_path, output_dir)
