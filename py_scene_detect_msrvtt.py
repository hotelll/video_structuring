...
if __name__ == "__main__":
    ...
    main_out_dir = "/mnt/sdb/dataset/msrvtt_qa/video_frames"
    with open("/home/hetianyao/Video-LLaVA/datasets/MSRVTT_QA/video_list.json", "r") as f:
        video_list = json.load(f)
    finished_list = os.listdir("/mnt/sdb/dataset/msrvtt_qa/video_frames")
